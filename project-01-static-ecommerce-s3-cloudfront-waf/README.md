...
This project demonstrates how to deploy a **secure static e-commerce website on AWS** using **Amazon S3, Amazon CloudFront, and AWS WAF**.
...
- **Resilient Architecture** – S3 durability and versioning
- **Cost Optimization** – Serverless static hosting
